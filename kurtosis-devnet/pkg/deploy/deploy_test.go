...
// mockEnclaveContext implements artifact.EnclaveContextIface for testing
...
func TestDeploy(t *testing.T) {
	...
	mockEnclaveFSFunc := func(ctx context.Context, enclave string) (*artifact.EnclaveFS, error) {
		...
		return artifact.NewEnclaveFSWithContext(mockCtx), nil
	}
...
func TestGetNextDevnetDescriptor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			fs := artifact.NewEnclaveFSWithContext(mockCtx)
